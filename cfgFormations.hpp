class GenericFormationBasePublic
{
	name = "Generic base class formation for public";
	class Fixed
	{
...
class GenericTeamWedgeLeftPublic: GenericFormationBasePublic
{
	name = "Generic Team Wedge Left Public";
	class Fixed
	{
...
class GenericTeamWedgeRightPublic: GenericFormationBasePublic
{
	name = "Generic Team Wedge Right Public";
	class Fixed
	{
		FormationPositionInfo0[] = {0, 0, 0, 0, true, "TL"};
		FormationPositionInfo1[] = {0, -5, -3, 6, true, "MG"};
...
class GenericTeamScatteredPublic: GenericFormationBasePublic
{
	name = "Generic Team Scattered Public";
	class Fixed
	{
		FormationPositionInfo0[] = {0, 0, 0, 0, true, "TL"};
...
class GenericSquadOrderLeftPublic: GenericFormationBasePublic
{
	name = "Generic Squad Order Left Public";
	class Fixed
	{
...
class GenericSquadOrderRightPublic: GenericFormationBasePublic
{
	name = "Generic Squad Order Right Public";
	class Fixed
	{
		FormationPositionInfo0[] = {0, 0, 0, 0, true, "LD"};
		FormationPositionInfo1[] = {0, 15, -10, 0, true, "FF"};
